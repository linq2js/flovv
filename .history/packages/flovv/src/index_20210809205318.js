...
export function processFlow(
  ...
  return commands[keys[0]](value[keys[0]], {
    fork: (iterator, ct, onSuccess, onError) =>
      processFlow(iterator, undefined, commands, ct, onSuccess, onError),
    onSuccess: (result) => {
...
function createFlow(fn, getState, commands) {
  ...
  commands = {
    ...
    get(payload, ...args) {
      ...
      const propArray = Array.isArray(payload) ? payload : [payload];
      // listen
      ...
      return commands.get(payload, ...args);
    },
  };
